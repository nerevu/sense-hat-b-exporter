...
class ICM20948(object):
    def __init__(self, address=I2C_ADD_ICM20948):
        ...
        self.icm20948Check()  # Initialization of the device multiple times after power on will result in a return error
        # while TRUE != bRet:
    ...
    def orientation(self):
        ...
        roll = (
            math.atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2 * q2 + 1) * 57.3
        )
        yaw = (
            math.atan2(-2 * q1 * q2 - 2 * q0 * q3, 2 * q2 * q2 + 2 * q3 * q3 - 1) * 57.3
        )
